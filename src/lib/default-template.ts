...
export const DEFAULT_TEMPLATE: SavedLayout = {
  ...
  nodes: [
    ...
    // Compressors
    { id: 'comp-01', type: 'equipment', position: { x: 20, y: 60 }, data: { tagName: 'COMP-01', displayName: 'Rotary Screw A', equipmentType: 'compressor', status: 'RUN', icon: 'Fan', opcTag: '', mqttTopic: '', apiEndpoint: '', staticValue: '', width: 170, height: 140, color: '#E0F7FA', borderColor: '#00ACC1', glowEffect: true } },
    { id: 'comp-02', type: 'equipment', position: { x: 20, y: 220 }, data: { tagName: 'COMP-02', displayName: 'Rotary Screw B', equipmentType: 'compressor', status: 'STOP', icon: 'Fan', opcTag: '', mqttTopic: '', apiEndpoint: '', staticValue: '', width: 170, height: 140, color: '#E0F7FA', borderColor: '#00ACC1', glowEffect: false } },
    { id: 'comp-03', type: 'equipment', position: { x: 20, y: 380 }, data: { tagName: 'COMP-03', displayName: 'Rotary Screw C', equipmentType: 'compressor', status: 'STOP', icon: 'Fan', opcTag: '', mqttTopic: '', apiEndpoint: '', staticValue: '', width: 170, height: 140, color: '#E0F7FA', borderColor: '#00ACC1', glowEffect: false } },

    // Dryers
    { id: 'dry-01', type: 'equipment', position: { x: 280, y: 100 }, data: { tagName: 'DRY-01', displayName: 'Refrigerated Dryer A', equipmentType: 'dryer', status: 'RUN', icon: 'Droplets', opcTag: '', mqttTopic: '', apiEndpoint: '', staticValue: '', width: 150, height: 100, color: '#E8F5E9', borderColor: '#43A047', glowEffect: false } },
    { id: 'dry-02', type: 'equipment', position: { x: 280, y: 280 }, data: { tagName: 'DRY-02', displayName: 'Refrigerated Dryer B', equipmentType: 'dryer', status: 'STOP', icon: 'Droplets', opcTag: '', mqttTopic: '', apiEndpoint: '', staticValue: '', width: 150, height: 100, color: '#E8F5E9', borderColor: '#43A047', glowEffect: false } },

    // Tank
    { id: 'tk-101', type: 'equipment', position: { x: 510, y: 100 }, data: { tagName: 'TK-101', displayName: 'Receiver Tank', equipmentType: 'receiver-tank', status: 'RUN', icon: 'Container', opcTag: '', mqttTopic: '', apiEndpoint: '', staticValue: '7.25 bar', width: 90, height: 160, color: '#E8EAF6', borderColor: '#3949AB', glowEffect: false } },

    // Valve
    { id: 'xv-101', type: 'equipment', position: { x: 660, y: 170 }, data: { tagName: 'XV-101', displayName: 'Primary Isolation', equipmentType: 'valve', status: 'RUN', icon: 'Zap', opcTag: '', mqttTopic: '', apiEndpoint: '', staticValue: '', width: 60, height: 50, color: '#FFFDE7', borderColor: '#F9A825', glowEffect: false } },

    // Sensors
    { id: 'dpt-101', type: 'equipment', position: { x: 350, y: 55 }, data: { tagName: 'DPT-101', displayName: 'Dew Point', equipmentType: 'pressure-transmitter', status: 'RUN', icon: 'Gauge', opcTag: '', mqttTopic: '', apiEndpoint: '', staticValue: '-40.0°C', width: 110, height: 50, color: '#FBE9E7', borderColor: '#D84315', glowEffect: false } },
    { id: 'pt-102', type: 'equipment', position: { x: 650, y: 80 }, data: { tagName: 'PT-102', displayName: 'Header Pressure', equipmentType: 'pressure-transmitter', status: 'RUN', icon: 'Gauge', opcTag: '', mqttTopic: '', apiEndpoint: '', staticValue: '7.15 bar', width: 110, height: 50, color: '#FBE9E7', borderColor: '#D84315', glowEffect: false } },

    // Flow Meters
    { id: 'ft-101', type: 'equipment', position: { x: 750, y: 120 }, data: { tagName: 'FT-101', displayName: 'Main Flow', equipmentType: 'flow-meter', status: 'RUN', icon: 'Activity', opcTag: '', mqttTopic: '', apiEndpoint: '', staticValue: '850', width: 130, height: 120, color: '#E1F5FE', borderColor: '#0288D1', glowEffect: false } },
    { id: 'ft-201', type: 'equipment', position: { x: 920, y: 60 }, data: { tagName: 'FT-201', displayName: 'Weaving Flow', equipmentType: 'flow-meter', status: 'RUN', icon: 'Activity', opcTag: '', mqttTopic: '', apiEndpoint: '', staticValue: '450', width: 130, height: 120, color: '#E1F5FE', borderColor: '#0288D1', glowEffect: false } },
    { id: 'ft-202', type: 'equipment', position: { x: 920, y: 300 }, data: { tagName: 'FT-202', displayName: 'Spinning Flow', equipmentType: 'flow-meter', status: 'RUN', icon: 'Activity', opcTag: '', mqttTopic: '', apiEndpoint: '', staticValue: '400', width: 130, height: 120, color: '#E1F5FE', borderColor: '#0288D1', glowEffect: false } },
