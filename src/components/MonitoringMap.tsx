...
function MonitoringMapInner({
  ...
  const { isNodeVisible } = useCanvasState('hmi-compressed-air', DEFAULT_NODES, DEFAULT_PIPES);
...
{/* ========================================================= */}
          ...
          <g className="stroke-[#94a3b8] dark:stroke-slate-600 opacity-60" strokeWidth="1" strokeDasharray="4,4" fill="none">
            {/* DPT-101 Leader: orthongal from badge to pipe */}
            <path d="M 405,125 L 430,125 L 430,185" strokeLinejoin="round" />
            <polygon points="427,181 433,181 430,185" className="fill-[#94a3b8] dark:fill-slate-600 stroke-none" />

            {/* TT-101 Leader */}
            <path d="M 405,70 L 445,70 L 445,185" strokeLinejoin="round" />
            <polygon points="442,181 448,181 445,185" className="fill-[#94a3b8] dark:fill-slate-600 stroke-none" />

            {/* PT-102 Leader */}
            <path d="M 585,115 L 585,185" strokeLinejoin="round" />
            <polygon points="582,181 588,181 585,185" className="fill-[#94a3b8] dark:fill-slate-600 stroke-none" />

            {/* Boiler System Leaders */}
            <g className="stroke-slate-400 dark:stroke-slate-500" strokeWidth="1" fill="none">
              {/* PT-HB Leader */}
              <path d="M 500,550 L 500,584" strokeLinejoin="round" />
              <polygon points="497,580 503,580 500,584" className="fill-slate-400 dark:fill-slate-500 stroke-none" />

              {/* TT-HB Leader */}
              <path d="M 590,550 L 590,600" strokeLinejoin="round" />
              <polygon points="587,596 593,596 590,600" className="fill-slate-400 dark:fill-slate-500 stroke-none" />
            </g>
          </g>
        </svg>
...
export default React.memo(MonitoringMapInner);
