...
function Handles({ selected }: { selected?: boolean }) {
  ...
  return (
    <>
      ...
      <Handle type="source" position={Position.Top} id="source-top" className={`${handleStyle} ${baseStyle} !-top-1.5`} />

      <Handle type="target" position={Position.Bottom} id="target-bottom" className={`${handleStyle} ${baseStyle} !-bottom-1.5`} />
      <Handle type="source" position={Position.Bottom} id="source-bottom" className={`${handleStyle} ${baseStyle} !-bottom-1.5`} />

      <Handle type="target" position={Position.Left} id="target-left" className={`${handleStyle} ${baseStyle} !-left-1.5`} />
      <Handle type="source" position={Position.Left} id="source-left" className={`${handleStyle} ${baseStyle} !-left-1.5`} />
